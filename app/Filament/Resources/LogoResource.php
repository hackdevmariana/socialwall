...
class LogoResource extends Resource
{
    ...
    public static function form(Form $form): Form {
        return $form->schema([
            TextInput::make('first_word')->required(),
            TextInput::make('second_word'),
    ...
    public static function table(Table $table): Table {
        return $table->columns([
            TextColumn::make('first_word')->sortable(),
            TextColumn::make('second_word')->sortable(),
            TextColumn::make('slogan')->sortable(),
        ]);
    }
